  ...
  constructor(opts) {
    ...
    if (opts.sourceSlices && opts.destSlices) {
      ...
      this._sourceSlicesHor = [
        opts.sourceSlices.hor.left,
        opts.sourceSlices.hor.center,
        opts.sourceSlices.hor.right
      ];
      this._sourceSlicesVer = [
        opts.sourceSlices.ver.top,
        opts.sourceSlices.ver.middle,
        opts.sourceSlices.ver.bottom
      ];
      this._destSlicesHor = [
        opts.destSlices.hor.left,
        0,
        opts.destSlices.hor.right
      ];
      this._destSlicesVer = [
        opts.destSlices.ver.top,
        0,
        opts.destSlices.ver.bottom
      ];
